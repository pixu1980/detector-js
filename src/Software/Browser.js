...
export default class Browser extends CssFlagsClass {
  ...
  get Baidu() {
    return this._checkAssertsResult(
      Asserts.one([this._reTest('(?:(?:b(?:(?:a)?idu)?(?:d)?)(?:browser)(?:\\_i18n)?)' + this._reStrVerNum)])
    );
  }
  ...
  get Brave() {
    return this._checkAssertsResult(
      Asserts.one([!!window.navigator.brave || !!window.navigator.Brave, this._reTest('(?:brave)' + this._reStrVerNum)])
    );
  }
   ...
   */
  get IceBrowser() {
    return this._checkAssertsResult(Asserts.one([this._reTest('(?:ices?browser)' + this._reStrVerNum)]));
  }
   ...
   */
  get Maemo() {
    return this._checkAssertsResult(Asserts.one([this._reTest('(?:maemosbrowser)' + this._reStrVerNum)]));
  }
  ...
  get Maxthon() {
    return this._checkAssertsResult(
      Asserts.all([!this.MaxthonMobile, this._reTest('(?:maxthon|mxnitro)' + this._reStrVerNum)])
    );
  }
   ...
   */
  get NokiaBrowser() {
    return this._checkAssertsResult(Asserts.all([this._reTest('(?:nokias?browser)' + this._reStrVerNum)]));
  }
  ...
  get QQBrowser() {
    return this._checkAssertsResult(
      Asserts.all([!this.QQBrowserMobile, this._reTest('(?:qq(?:browser)?(?:lite)?)' + this._reStrVerNum)])
    );
  }
  ...
  get AndroidBrowser() {
    return this._checkAssertsResult(
      Asserts.all([!this._reTest('like android'), this._reTest('(?:android.*)' + this._reStrVer)])
    );
  }
  ...
  get ChromeMobile() {
    return this._checkAssertsResult(
      Asserts.all([!this._reTest('like chrome'), this._reTest('((?:android.+)crmo|crios)' + this._reStrVerNum)])
    );
  }
  ...
  get Edge() {
    return this._checkAssertsResult(
      Asserts.all([!this.IE, this._reTest('(?:^(?:(?!mobile|android|ios).)*)(?:edge)' + this._reStrVerNum)])
    );
  }
  ...
  get IE() {
    return this._checkAssertsResult(
      Asserts.all([!this.IEMobile, /(?:msie|ie|trident).*(?:;\srv:(?:(\w+(?:(?:\.|\_)\w+)+)|\d+))/i.test(this._ua)])
    );
  }
   ...
   */
  get OperaMini() {
    return this._checkAssertsResult(Asserts.one([this._reTest('(?:operasmini)' + this._reStrVerNum)]));
  }
  ...
  get OperaMobile() {
    ...
    return this._checkAssertsResult(
      Asserts.one([!!this._root.opera, !!this._root.opr]) &&
        Asserts.one([
          this.OperaMini,
          this.OperaCoast,
          this.OperaTouch,
  ...
  get Opera() {
    return this._checkAssertsResult(
      Asserts.one([!!this._root.opera, !!this._root.opr]) &&
        ...
        Asserts.one([this._reTest('(?:op(?:era|r)|mms)' + this._reStrVerNum)]),
      true
    );
  }
  ...
  get SafariMobile() {
    return this._checkAssertsResult(
      Asserts.all([/iphone|ipad|ipod/i.test(this._ua), !this.AndroidBrowser, !this.Chrome, !this.PhantomJS]) &&
        Asserts.one([

...
export default class OS extends CssFlagsClass {
  ...
  get Windows() {
    return this._checkAssertsResult(
      Asserts.all([/Win/i.test(this._ua)]) &&
        Asserts.one([
  ...
  get macOS() {
    return this._checkAssertsResult(
      Asserts.all([!this.iOS, !/mobile\//i.test(this._ua), /mac/i.test(this._ua), !/like mac/i.test(this._ua)]) &&
        Asserts.one([/(macintosh|mac(?=_powerpc)\s)/i.test(this._ua), /(mac\sos\sx)\s?([\w\s\.]*)/i.test(this._ua)]) &&
        Asserts.one([
  ...
  get Unix() {
    return this._checkAssertsResult(
      Asserts.all([/X11/i.test(this._ua)]) && Asserts.one([/(unix)\s?([\w\.]*)/i.test(this._ua)]),
      null,
  ...
  get Linux() {
    return this._checkAssertsResult(
      Asserts.all([!this.Android, /Linux/i.test(this._ua)]),
      null,
  ...
  get Solaris() {
    return this._checkAssertsResult(
      Asserts.one([/(sunos)\s?([\w\.\d]*)/i.test(this._ua), /((?:open)?solaris)[\/\s-]?([\w\.]*)/i.test(this._ua)])
    );
  }
  ...
  get iOS() {
    return this._checkAssertsResult(
      Asserts.all([!window.MSStream, /iP(?:ad|hone|od)/.test(this._ua)]) &&
        Asserts.one([/os\s((\d+([_\s]\d+)*)|(\d+(?:[_\.]\d+)*)) like mac os x/i.test(this._ua)])
    );
  }
  ...
  get Android() {
    return this._checkAssertsResult(
      Asserts.one([/android[\s/-](\d+(\.\d+)*)/i.test(this._ua)]),
      null,
  ...
  get Bada() {
    return this._checkAssertsResult(
      Asserts.one([/(bada)[\/\s-]?([\w\.]*)/i.test(this._ua), /bada\/(\d+(\.\d+)*)/i.test(this._ua)])
    );
  }
  ...
  get Blackberry() {
    return this._checkAssertsResult(
      Asserts.one([/blackberry|\bbb\d+/i.test(this._ua), /rim\stablet/i.test(this._ua)]) &&
        Asserts.one([

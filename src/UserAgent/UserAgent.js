/*!
 * UserAgent - a browser detector
 * https://github.com/lancedikson/UserAgent
 * MIT License | (c) Dustin Diaz 2012-2015
 * MIT License | (c) Denis Demchenko 2015-2017
 */
import browserParsersList from './Browsers';
import osParsersList from './OS';
import platformParsersList from './Platforms';
import enginesParsersList from './Engines';
...
export default class UserAgent {
   ...
   * @constructor
   */
  constructor(UA = window.navigator.userAgent, skipParsing = false) {

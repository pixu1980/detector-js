var $dlFi5$detectorjscore = require("@detector-js/core");
...
var $ef23c985e5649af8$exports = {};

$parcel$export($ef23c985e5649af8$exports, "Browser", () => $ef23c985e5649af8$export$5fefc2586e00a689);

class $ef23c985e5649af8$export$5fefc2586e00a689 extends (0, $dlFi5$detectorjscore.CssFlagsClass) {
    #reStrVerNum;
    #reStrVer;
    #reVer;
    /**
   ...
   * @memberOf Browser
   */ get Amaya() {
        return this.#checkAssertsResult((0, $dlFi5$detectorjscore.Asserts).all([
   ...
   * @memberOf Browser
   */ get Avant() {
        return this.#checkAssertsResult((0, $dlFi5$detectorjscore.Asserts).one([
   ...
   */ get Brave() {
        ...
        (0, $dlFi5$detectorjscore.Asserts).one([
   ...
   * @memberOf Browser
   */ get Yandex() {
        return (0, $dlFi5$detectorjscore.Asserts).one([
   ...
   */ get Opera() {
        ...
        (0, $dlFi5$detectorjscore.Asserts).one([
            !!this.root.opera,
            !!this.root.opr
        ]) && (0, $dlFi5$detectorjscore.Asserts).all([
            !this.OperaMobile
        ]) && (0, $dlFi5$detectorjscore.Asserts).one([
...
var $3e347ec9821bd83f$exports = {};

$parcel$export($3e347ec9821bd83f$exports, "Engine", () => $3e347ec9821bd83f$export$2c3b404bf3a77a1f);

class $3e347ec9821bd83f$export$2c3b404bf3a77a1f extends (0, $dlFi5$detectorjscore.CssFlagsClass) {
    /**
   ...
   * @memberOf Engine
   */ get Amaya() {
        return this._checkAssertsResult((0, $dlFi5$detectorjscore.Asserts).all([
   ...
   * @memberOf Engine
   */ get Presto() {
        return this._checkAssertsResult((0, $dlFi5$detectorjscore.Asserts).one([
...
var $69fd0fec61e94cbc$exports = {};

$parcel$export($69fd0fec61e94cbc$exports, "OS", () => $69fd0fec61e94cbc$export$decc4a6e69bbf763);
/* eslint-disable quote-props */ /* eslint-disable no-else-return */ /* eslint-disable radix */ /* eslint-disable indent */ 
class $69fd0fec61e94cbc$export$decc4a6e69bbf763 extends (0, $dlFi5$detectorjscore.CssFlagsClass) {
    /**
...
"use strict";
$parcel$exportWildcard(module.exports, $ef23c985e5649af8$exports);
$parcel$exportWildcard(module.exports, $3e347ec9821bd83f$exports);
$parcel$exportWildcard(module.exports, $69fd0fec61e94cbc$exports);

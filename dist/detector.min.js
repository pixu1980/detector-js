(function (global, factory) {
  ...
  function (_CssFlagsClass) {
    ...
    _createClass(Feature, [{
      ...
      key: "touch",
      get: function get() {
        return Asserts.one(['ontouchstart' in window, 'ontouchstart' in document.documentElement, window.DocumentTouch && document instanceof window.DocumentTouch, window.navigator && window.navigator.msPointerEnabled && window.MSGesture, window.navigator.maxTouchPoints && window.navigator.maxTouchPoints > 1], true);
      }
    }, {
      key: "forceTouch",
      get: function get() {
        return Asserts.one([window.MouseEvent.WEBKIT_FORCE_AT_MOUSE_DOWN && window.MouseEvent.WEBKIT_FORCE_AT_FORCE_MOUSE_DOWN], true);
  ...
  function (_CssFlagsClass) {
    ...
    _createClass(Platform, [{
      ...
      key: "desktop",
      get: function get() {
        return Asserts.one([window.orientation === undefined, !this.mobile]);
      }
    }, {
      key: "bot",
      get: function get() {

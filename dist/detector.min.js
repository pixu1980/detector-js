(function (global, factory) {
    ...
    _createClass(FlagsClass, [{
      ...
      value: function toCssFlags() {
        ...
        return Object.getOwnPropertyNames(proto).filter(function (prop) {
          ...
          if (!!_this2[item]) {
            acc.push(_this2._cssFlagsPrefix + '--' + item.toLowerCase() + (typeof _this2[item] !== 'boolean' ? '--' + _this2[item] : ''));
          }
  ...
  function (_FlagsClass) {
    ...
    _createClass(OS, [{
      key: "Windows",
      get: function get() {
        return Asserts.one([/Win/i.test(this._ua)]);
      }
    }, {
      key: "macOS",
      get: function get() {
        return Asserts.all([/Mac/i.test(this._ua), !/like Mac/i.test(this._ua), !this.iOS, !/Mobile\//i.test(this._ua)]);
      }
    }, {
      key: "Unix",
      get: function get() {
        return Asserts.one([/X11/i.test(this._ua)]);
      }
    }, {
      key: "Linux",
      get: function get() {
        return Asserts.all([/Linux/i.test(this._ua), !this.Android]);
      } //! Mobile OSs

    }, {
      key: "iOS",
      get: function get() {
        return Asserts.one([/iPad|iPhone|iPod/i.test(this._ua) && !window.MSStream]);
      }
    }, {
      key: "Android",
      get: function get() {
        return Asserts.one([/Android/i.test(this._ua)]);
      }
    }, {
      key: "Bada",
      get: function get() {
        return Asserts.all([/bada/i.test(this._ua), /dolfin\/(\d+(\.?_?\d+)+)/i.test(this._ua)]);
      }
    }, {
      key: "Blackberry",
      get: function get() {
        return Asserts.one([/blackberry|\bbb\d+/i.test(this._ua), /rim\stablet/i.test(this._ua)]) && Asserts.all([/blackberry[\d]+\/(\d+(\.?_?\d+)+)/i.test(this._ua)]);
      } //! TV OSs
      ...
      key: "WebOS",
      get: function get() {
        return Asserts.one([/(web|hpw)[o0]s/i.test(this._ua), /w(?:eb)?[o0]sbrowser\/(\d+(\.?_?\d+)+)/i.test(this._ua)]);
      }
    }]);
  ...
  function (_FlagsClass) {
    ...
    function Browsers() {
      ...
      _this.setVersionFromRegExp();

      return _this;
    }

    _createClass(Browsers, [{
      key: "checkAssertsResult",
      value: function checkAssertsResult() {
      ...
      key: "setVersionFromRegExp",
      value: function setVersionFromRegExp() {
      ...
      key: "AndroidBrowser",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([!/like android/i.test(this._ua), /android/i.test(this._ua), /(?:chrome|crios|crmo)\/(\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "BlackBerry",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/blackberry|\bbb\d+/i.test(this._ua), /rim\stablet/i.test(this._ua)]) && Asserts.all([/blackberry[\d]+\/(\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "BadaBrowser",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/bada/i.test(this._ua), /dolfin\/(\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "Brave",
      get: function get() {
        return Asserts.one([/bada/i.test(this._ua), /dolfin\/(\d+(\.?_?\d+)+)/i.test(this._ua)]);
      }
    }, {
      key: "Chrome",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(?:chrome|crios|crmo)\/(\d+(\.?_?\d+)+)/i.test(this._ua), !this.AndroidBrowser]));
      }
    }, {
      key: "Chromium",
      get: function get() {
      ...
      key: "Edge",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([!this.IE, /edg([ea]|ios)\/(\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "Electron",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([typeof window !== 'undefined' && _typeof(window.process) === 'object' && window.process.type === 'renderer', // Renderer process
        typeof process !== 'undefined' && _typeof(process.versions) === 'object' && !!process.versions.electron, // Main process
        _typeof(window.navigator) === 'object' && typeof this._ua === 'string' && this._ua.indexOf('Electron') >= 0]));
      }
    }, {
      key: "Epiphany",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/(?:epiphany)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "Firefox",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/firefox/i.test(this._ua)]));
      }
    }, {
      key: "Focus",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/(?:focus)[\s/](\d+(?:\.\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "GoogleBot",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/googlebot\/(\d+(\.\d+))/i.test(this._ua)]));
      }
    }, {
      key: "IE",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(msie|trident)/i.test(this._ua), /(?:msie |rv:)(\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "KMeleon",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(?:k-meleon)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "Maxthon",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(?:Maxthon|mxios)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "MZBrowser",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(?:MZBrowser)[\s/](\d+(?:\.\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "Opera",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/(?:opera)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua), /(?:opr)[\s/](\S+)/i.test(this._ua)]), true);
      }
    }, {
      key: "OperaMini",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/(?:opios)[\s/](\S+)/i.test(this._ua)]));
      }
    }, {
      key: "OperaCoast",
      get: function get() {
        // a.k.a. Opera Coast
        return this.checkAssertsResult(Asserts.one([/(?:coast)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "PhantomJS",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/phantom/i.test(this._ua), /phantomjs\/(\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "Puffin",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/(?:puffin)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "Safari",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/safari|applewebkit/i.test(this._ua), /safari/i.test(this._ua) && !this.Chrome && !this.PhantomJS]) && Asserts.all([!this.AndroidBrowser]));
      }
    }, {
      key: "SafariMobile",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/iphone|ipad|ipod/i.test(this._ua), /safari/i.test(this._ua) && !this.Chrome && !this.PhantomJS && !this.AndroidBrowser]));
      }
    }, {
      key: "Sailfish",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/sailfish\s?browser\/(\d+(\.\d+)?)/i.test(this._ua)]));
      }
    }, {
      key: "Silk",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/silk\/(\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "SlimerJS",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/slimerjs\/(\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "SeaMonkey",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/seamonkey\/(\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "SamsungBrowser",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(?:SamsungBrowser)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "Sleipnir",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(?:sleipnir)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "Swing",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(?:swing)[\s/](\d+(?:\.\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "UCBrowser",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(?:ucbrowser)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "Vivaldi",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/vivaldi\/(\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "WebOSBrowser",
      get: function get() {
        return this.checkAssertsResult(Asserts.one([/(web|hpw)[o0]s/i.test(this._ua), /w(?:eb)?[o0]sbrowser\/(\d+(\.?_?\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "WeChat",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(?:micromessenger)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
    }, {
      key: "Whale",
      get: function get() {
        return this.checkAssertsResult(Asserts.all([/(?:whale)[\s/](\d+(?:\.\d+)+)/i.test(this._ua)]), true);
      }
    }, {
      key: "Yandex",
      get: function get() {
  ...
  function (_FlagsClass) {
    ...
    _createClass(Engines, [{
      key: "Blink",
      get: function get() {
        return Asserts.all([!!window.Intl && !!Intl.v8BreakIterator, 'CSS' in window, /webkit\/537\.36.+chrome\/(?!27)/i.test(this._ua)]);
      }
    }, {
      key: "WebKit",
      get: function get() {
        return Asserts.all([typeof window.webkitConvertPointFromNodeToPage === 'function', /(?:apple)?webkit\/([\w\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "Trident",
      get: function get() {
      ...
      key: "EdgeHTML",
      get: function get() {
        return Asserts.all([!!window.StyleMedia, /edge\/(\d+(\.?_?\d+)+)/i.test(this._ua) || /windows.+\sedge\/([\w\.]+)/i.test(this._ua), !this.Trident]);
      }
    }, {
      key: "Gecko",
      get: function get() {
        return Asserts.all([typeof InstallTrigger !== 'undefined', /rv\:([\w\.]{1,9}).+(gecko)/i.test(this._ua)]);
      }
    }, {
      key: "NetFront",
      get: function get() {
        return Asserts.all([/(netfront)\/([\w\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "NetSurf",
      get: function get() {
        return Asserts.all([/(netsurf)\/([\w\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "Amaya",
      get: function get() {
        return Asserts.all([/(amaya)\/([\w\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "KHTML",
      get: function get() {
        return Asserts.all([/(khtml)[\/\s]\(?([\w\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "Presto",
      get: function get() {
        return Asserts.all([/(presto)\/([\w\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "iCab",
      get: function get() {
        return Asserts.all([/(icab)[\/\s]([23]\.[\d\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "Tasman",
      get: function get() {
        return Asserts.all([/(tasman)[\/\s]\(?([\w\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "W3M",
      get: function get() {
        return Asserts.all([/(w3m)\/([\w\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "Goanna",
      get: function get() {
        return Asserts.all([/(goanna)\/([\w\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "Linx",
      get: function get() {
        return Asserts.all([/(lynx)\/([\w\.]+)/i.test(this._ua)]);
      }
    }, {
      key: "Links",
      get: function get() {
        return Asserts.all([/(links)[\/\s]\(?([\w\.]+)/i.test(this._ua)]);
      }
    }]);

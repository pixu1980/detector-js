(function (global, factory) {
  ...
  function (_CssFlagsClass) {
    ...
    function Feature() {
      ...
      _this._cssPrefixes = ['spec', 'webkit', 'moz', 'ms', 'o'];
      _this._performance = window.performance || window.mozPerformance || window.msPerformance || window.webkitPerformance || {};
      console.log(_this._performance);
      ...
      _this.worker = _this.getWorker(); // remove unnecessary memory usage
    ...
    _createClass(Feature, [{
      ...
      value: function _getCssPrefixedPropValue(prop, value) {
        ...
        if (prefixedProp) {
          ...
          var computedStylePropValue = window.getComputedStyle(this._div).getPropertyValue(prefixedProp);
      ...
      key: "_destroyTestElements",
      value: function _destroyTestElements() {
        this._script = null;
        this._canvas = null;
        this._div = null;
        this._input = null;
      ...
      value: function getFile() {
        return Asserts.all(['File' in window, 'FileReader' in window, 'FileList' in window, 'Blob' in window]);
      }
      /**
       *
       *
      ...
      value: function getFullscreenKeyboard() {
        return Asserts.all([function () {
          return 'Element' in window && 'ALLOW_KEYBOARD_INPUT' in window.Element;
        }]);
      }
      /**
       *
      ...
      value: function getTypedArray() {
        return Asserts.all([function () {
          return 'Int8Array' in window && typeof Int8Array !== 'undefined';
        }], true);
      }
      /**
       *
      ...
      value: function getUserMedia() {
        return Asserts.one(['getUserMedia' in window.navigator, 'webkitGetUserMedia' in window.navigator, 'mozGetUserMedia' in window.navigator, 'msGetUserMedia' in window.navigator]);
      }
      /**
       *
       *
      ...
      value: function getVibration() {
        return Asserts.one(['vibrate' in window.navigator, 'webkitVibrate' in window.navigator, 'mozVibrate' in window.navigator, 'msVibrate' in window.navigator]);
      }
      /**
       *
       *
      ...
      key: "pointerEnabled",
      get: function get() {
        return Asserts.one(['pointerEnabled' in window.navigator, 'msPointerEnabled' in window.navigator]);
      }
      /**
       *
       *
      ...
      key: "pointerLock",
      get: function get() {
        return Asserts.one(['pointerLockElement' in document, 'webkitPointerLockElement' in document, 'mozPointerLockElement' in document]);
      }
      /**
       *
       *
      ...
      key: "contextMenu",
      get: function get() {
        return Asserts.all(['contextMenu' in document, 'HTMLMenuItemElement' in window]);
      ...
      get: function get() {
        ...
        return Asserts.all([function () {
          return _this3._img.style.width = _this3._img.style.width !== '';
        }]);
      ...
      get: function get() {
        ...
        return Asserts.all([function () {
          return _this4._img.style.width = _this4._img.style.width !== '';
        }]);
      ...
      get: function get() {
        ...
        return Asserts.all([function () {
          return 'getContext' in _this5._canvas && _this5._canvas.getContext('2d');
        }]);
      ...
      get: function get() {
        return Asserts.all([function () {
          return 'createElementNS' in document && 'createSVGRect' in document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        }]);
      ...
      get: function get() {
        ...
        return Asserts.one([function () {
          return _this6.canvas && 'WebGL2RenderingContext' in window && _this6._canvas.getContext('webgl2');
        }, function () {
          return _this6.canvas && 'WebGLRenderingContext' in window && (_this6._canvas.getContext('webgl') || _this6._canvas.getContext('experimental-webgl'));
        }], true);
      ...
      get: function get() {
        ...
        return Asserts.one(['ontouchstart' in window, 'ontouchstart' in document.documentElement]) && Asserts.one([function () {
          return 'DocumentTouch' in window && document instanceof window.DocumentTouch;
        }, function () {
          return _this7.pointerEnabled() && 'MSGesture' in window;
        }, function () {
          return 'maxTouchPoints' in window.navigator && window.navigator.maxTouchPoints > 1;
        }], true);
      }
      /**
       *
      ...
      get: function get() {
        return Asserts.all([function () {
          return 'MouseEvent' in window && 'WEBKIT_FORCE_AT_MOUSE_DOWN' in window.MouseEvent && 'WEBKIT_FORCE_AT_FORCE_MOUSE_DOWN' in window.MouseEvent;
        }], true);
  ...
  function (_CssFlagsClass) {
    ...
    _createClass(VideoFeature, [{
      ...
      get: function get() {
        ...
        return Asserts.all(['HTMLVideoElement' in window, 'HTMLMediaElement' in window, function () {
          return !!_this5._videoElement && 'canPlayType' in _this5._videoElement && _this5._videoElement instanceof window.HTMLVideoElement && _this5._videoElement instanceof window.HTMLMediaElement;
        }]);
      }
    }]);
  ...
  function (_CssFlagsClass) {
    ...
    function AudioFeature() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(AudioFeature).call(this, ua, flags, cssFlagsPrefix)); // Mimetypes accepted:
    ...
    _createClass(AudioFeature, [{
      ...
      value: function getContext() {
        return Asserts.one(['AudioContext' in window, 'webkitAudioContext' in window]);
      }
      /**
       *
       *
      ...
      get: function get() {
        ...
        return Asserts.all(['Audio' in window, 'HTMLAudioElement' in window, 'HTMLMediaElement' in window, function () {
          return !!_this8._audioElement && 'canPlayType' in _this8._audioElement && _this8._audioElement instanceof window.HTMLAudioElement && _this8._audioElement instanceof window.HTMLMediaElement;
        }], true);
      }
    }]);
  ...
  function (_CssFlagsClass) {
    ...
    _createClass(Platform, [{
      ...
      key: "tablet",
      get: function get() {
        return Asserts.all([this.mobile, /(ipad|tab(?:let)|kindle|playbook)/i.test(this._ua)]);
      }
      /**
       *
       *
      ...
      key: "smartTV",
      get: function get() {
        return Asserts.one([/(?:google|smart|internet\.|net|apple|pov\_|hbb)tv/i.test(this._ua), /(?:viera|netcast|boxee|kylo|dlnadoc|ce-html)/i.test(this._ua)]) && Asserts.all([!this.mobile, this._flags.feature.fullscreenKeyboard]) && Asserts.one([this._flags.os.Android, this._flags.os.Tizen, this._flags.os.WebOS]);
      }
      /**
       *
       *
      ...
      key: "desktop",
      get: function get() {
        return Asserts.all([!this.mobile, !this.bot, !this.tv]);
      }
      /**
       *
       *
  ...
  function (_CssFlagsClass) {
    ...
    function Device() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Device).call(this, ua, flags, cssFlagsPrefix)); // remove unnecessary memory usage
  ...
  function (_CssFlagsClass) {
    ...
    _createClass(OS, [{
      ...
      key: "WebOS",
      get: function get() {
        return this._checkAssertsResult(Asserts.all([/(web|hpw)[o0]s/i.test(this._ua)]) && Asserts.one([/(webos)[\/\s-]?([\w\.]*)/i.test(this._ua), /(?:web|hpw)[o0]s\/(\d+(\.\d+)*)/i.test(this._ua), /w(?:eb)?[o0]sbrowser\/(\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
      /**
       *
       *
  ...
  function (_CssFlagsClass) {
    ...
    _createClass(Browser, [{
      ...
      key: "Chrome",
      get: function get() {
        return this._checkAssertsResult(Asserts.all([!this.AndroidBrowser, !this.ChromeMobile]) && Asserts.one([/(chrome)\/v?([\w\.]+)/i.test(this._ua), /headlesschrome(?:\/([\w\.]+)|\s)/i.test(this._ua)]) && Asserts.one([/(?:chrome)\/(\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
      /**
       *
       *
  ...
  function (_CssFlagsClass) {
    ...
    _createClass(Engine, [{
      ...
      key: "WebKit",
      get: function get() {
        return this._checkAssertsResult(Asserts.one([typeof window.webkitConvertPointFromNodeToPage === 'function', /webkit\/(\d+(\.?_?\d+)+)/i.test(this._ua) || /(?:apple)?webkit\/([\w\.]+)/i.test(this._ua)]));
      }
    }]);
  ...
  function (_FlagsClass) {
    ...
    function Detector() {
      ...
      if (!!cssFlags) {
        _this._cssFlags = [];
        _this._cssFlagsPrefix = cssFlagsPrefix + (!!cssFlagsPrefix ? '--' : '');
      } //! Features


      _this.checkFeature(cssFlags); //! Software


      _this.checkEngine(cssFlags);

      _this.checkBrowser(cssFlags);

      _this.checkOS(cssFlags); //! Hardware


      _this.checkPlatform(cssFlags);

      _this.checkDevice(cssFlags);

      _this.checkCPU(cssFlags);

      _this.checkGPU(cssFlags);
      ...
      delete _this._ua;
      console.warn('DetectorJS initialized', _assertThisInitialized(_assertThisInitialized(_this)));
      return _this;
    }
    /**
     *

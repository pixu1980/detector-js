(function (global, factory) {
  ...
  function (_CssFlagsClass) {
    ...
    function Browser() {
      ...
      _this._spaceAndVersionDefaultRegExString = '(?:\\s|\\/)?(\\w+(?:(?:[._])\\w+)+)?';
      _this._versionDefaultRegEx = new RegExp('(?:version)' + _this._spaceAndVersionDefaultRegExString, 'i');
    ...
    _createClass(Browser, [{
      ...
      key: "Amaya",
      get: function get() {
        return this._checkAssertsResult(Asserts.all([new RegExp('(?:amaya)' + this._spaceAndVersionDefaultRegExString, 'i').test(this._ua)]));
      }
      /**
       *
       *
      ...
      key: "Arora",
      get: function get() {
        return this._checkAssertsResult(Asserts.all([new RegExp('(?:arora)' + this._spaceAndVersionDefaultRegExString, 'i').test(this._ua)]));
      }
      /**
       *
       *
      ...
      key: "Avant",
      get: function get() {
        return this._checkAssertsResult(Asserts.one([new RegExp('(?:avant(?:\sbrowser))' + this._spaceAndVersionDefaultRegExString, 'i').test(this._ua)]));
      }
      /**
       *
       *
      ...
      key: "Baidu",
      get: function get() {
        return this._checkAssertsResult(Asserts.one([new RegExp('(?:b(?:ai)?d(?:u)(?:browser|hd)(?:_i18n)?)' + this._spaceAndVersionDefaultRegExString, 'i').test(this._ua)]));
      }
      /**
       *
       *
      ...
      get: function get() {
        ...
        return this._checkAssertsResult(Asserts.one([function () {
          return !!_this2._process && _this2._process.type === 'renderer';
        }, // Renderer process
        function () {
          return !!_this2._process && _this2._process.versions === 'object' && !!_this2._process.versions.electron;
        }, // Main process
        function () {
      ...
      key: "MaxthonMobile",
      get: function get() {
        return this._checkAssertsResult(Asserts.one([/(?:mxios)[\s/](\d+(\.?_?\d+)+)/i.test(this._ua)]));
      }
      /**
       *
       *
      ...
      key: "Whale",
      get: function get() {
        return this._checkAssertsResult(Asserts.all([/(whale)(?:\s|\/)(\d+(?:(?:\.|\_)\d+)+)/i.test(this._ua)]), true);
      }
      /**
       *
       *
      ...
      key: "Yandex",
      get: function get() {
        return Asserts.one([/(?:ya(?:browser|ndex))(?:\s|\/)(\d+(?:(?:\.|\_)\d+)+)/i.test(this._ua)]);
      }
    }]);
  ...
  function (_FlagsClass) {
    ...
    function Detector() {
      ...
      var flags = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      var cssFlags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      var cssFlagsPrefix = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'djs';

  ...
  function (_CssFlagsClass) {
    ...
    _createClass(OS, [{
      ...
      get: function get() {
        ...
        return this._checkAssertsResult(Asserts.one([/(windows\sphone(?:\sos)*)[\s\/]?([\d\.\s\w]*)/i.test(this._ua), /(windows\smobile|windows)[\s\/]?([ntce\d\.\s]+\w)/i.test(this._ua), /windows phone (?:os)?\s?(\d+(\.\d+)*)/i.test(this._ua)])); // // Detect Windows Phone 7 desktop mode.

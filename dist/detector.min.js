(function (global, factory) {
  ...
  function (_FlagsClass) {
    ...
    function Browsers() {
      ...
      _this._version = _this._ua.match(/version\/(\d+(\.?_?\d+)+)/i)[1];
      return _this;
    }
    ...
    _createClass(Browsers, [{
      ...
      key: "AndroidBrowser",
      get: function get() {
        return Asserts.all([!/like android/i.test(this._ua), /android/i.test(this._ua)]);
      }
    }, {
      key: "Safari",
      get: function get() {
        return Asserts.one([/safari|applewebkit/i.test(this._ua)]);
      }
    }, {
      key: "Chrome",
      get: function get() {
      ...
      key: "IE",
      get: function get() {
        return Asserts.one([/(msie |rv:)(\d+(\.\d+)?)/i.test(this._ua)]);
      }
    }, {
      key: "Edge",
      get: function get() {
